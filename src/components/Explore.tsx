...
/**
 * Everyone on the app: search at the top, libraries worth following, and the
 * newest favorites across all profiles — outward discovery, distinct from
 * Home's "stuff for me" feeds.
 */
export default function Explore() {
  ...
  const openItem = (item: Item, e: React.MouseEvent<HTMLElement>) => {
    ...
    setQuick({ item, rect: thumb.getBoundingClientRect() });
  };

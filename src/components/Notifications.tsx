  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        onClick={toggle}
        className={`relative flex h-8 w-8 cursor-pointer items-center justify-center transition hover:bg-zinc-900/[0.05] ${
      ...
      {open && (
        <div
          className={`save-appear fixed inset-x-4 top-16 z-40 overflow-hidden border border-zinc-900/[0.06] bg-white/90 shadow-2xl backdrop-blur-xl sm:absolute sm:inset-x-auto sm:top-full sm:mt-2 sm:w-[22rem] sm:max-w-[calc(100vw-2rem)] ${
                      ...
                      {n.type === "taste" &&
                        ...
                        !tasteGiven.has(n.actor.id) && (
                          <button
                            ...
                            className="shrink-0 cursor-pointer whitespace-nowrap border border-zinc-200 px-2.5 py-1 text-[10px] font-medium text-zinc-500 transition hover:border-zinc-400 hover:text-zinc-900 disabled:cursor-wait"
                          >
                            Approve back
                          </button>
                        )}

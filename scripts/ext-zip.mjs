...
// against next dev), and zips to favorites-extension-v<version>.zip at the
...
const dir = join(tmp, "favorites-extension");
cpSync(src, dir, {
  recursive: true,
...
const out = join(root, `favorites-extension-v${manifest.version}.zip`);
